...
(rule22 ($and ($or (same cntxt color yellow)
                    (same cntxt color brown)
...
(rule23 ($and (same cntxt color brown)
...
(rule23a (same cntxt identity hognose-snake)
         (conclude cntxt latin-name
            "Heterodon nasicus" tally 1000))

(rule24 ($and (same cntxt color black)
               ($or (same cntxt size small)
                    (same cntxt size medium))
               (same cntxt pattern bands)
               (same cntxt environment grass))
...
(rule26 ($and ($or (same cntxt color black)
		 ...
		 (same cntxt color grey))
              ($or (same cntxt size medium)
        	   (same cntxt size large))
	      (same cntxt pattern stripes)
	      ($or (same cntxt environment woods)
	      	   (same cntxt environment grass)))
...
(rule29 ($and ($or (same cntxt color green)
                   (same cntxt color yellow))
		(same cntxt size medium)
		(same cantxt pattern stripes)
		($or (same cntxt environment meadows)
        	     (same cntxt environment prairies)))
...
(rule32 ($and (same cntxt color black)
